class zcl_gencust_values_result definition
  public
  create public .

  public section.

    types self type ref to zcl_gencust_values_result .

    class-methods ok
      importing
        !in           type zcl_gencust_types=>values
      returning
    ...
    methods constructor
      importing
        ...
        !value     type zcl_gencust_types=>values optional
    ...
    methods is_failure
      returning
        value(result) type abap_bool .
  private section.
    data value type zcl_gencust_types=>values.
...
class zcl_gencust_values_result implementation.
