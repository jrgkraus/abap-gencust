*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVI_GENCUSTIT2
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVI_GENCUSTIT2      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVI_GENCUSTIT2'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVI_GENCUSTIT2_EXTRACT
TOTAL = ZVI_GENCUSTIT2_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVI_GENCUSTIT2'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVI_GENCUSTIT2-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_GENCUSTIT2_EXTRACT
TOTAL = ZVI_GENCUSTIT2_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVI_GENCUSTIT2-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVI_GENCUSTIT2'
...
TOTAL = ZVI_GENCUSTIT2_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVI_GENCUSTIT2-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVI_GENCUSTIT2-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVI_GENCUSTIT2'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVI_GENCUSTIT2-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_GENCUSTIT2_EXTRACT
TOTAL = ZVI_GENCUSTIT2_TOTAL
